...
local function Defaults(id, type, caption)
...
aura_env.spells = {
    ["UNIT_SPELLCAST_START"] =
    {
        ...
        [388976] = Defaults(388976, "SHOCKWAVE" ), -- Arcane Ravager: Riftbreath
        ...
        [191508] = Defaults(191508),               -- Valarjar Aspirant: Blast of Light
        ...
        [392395] = Defaults(392395), -- Thunderhead: Thunder Jaw
        ...
        [396907] = Defaults(396907),               -- Yu'lon: Jade Fire Breath
    ...
    ["UNIT_SPELLCAST_SUCCEEDED"] = {
        ...
        -- Algethar Academy
        [390938] = Defaults(390938, "SOOTHE"), -- Aggravated Skitterfly: Agitation
        [387955] = Defaults(387955, "PURGE"), -- Ethereal Restorer: Celestial Shield
        [377389] = Defaults(377389, "SOOTHE"), -- Alpha Eagle: Call of the Flock

        -- Court of Stars
        [209033] = Defaults(209033, "PURGE"), -- Duskwatch Guard: Fortification
        --[225100] = Defaults(225100, "PURGE"), -- Guardian Construct: Charging Station; Can't be dispelled?

        -- Halls of Valor
        [198745] = Defaults(198745, "PURGE"), -- Stormforged Sentinel: Protective Light

        -- Nokhud Offensive
        [386223] = Defaults(386223, "PURGE"), -- Primal Stormshield: Stormshield

        -- Ruby Life Pools
        [372749] = Defaults(372749, "PURGE"), -- Flashfrost Chillweaver: Ice Shield
        [392454] = Defaults(392454, "PURGE"), -- Flame Channeler: Burning Veins; might not want to purge as it damages themselves

        -- Shadowmoon Burial Grounds
        [398151] = Defaults(398151, "PURGE"), -- Shadowmoon Loyalist: Sinister Focus

        -- Temple of the Jade Serpent
        [396018] = Defaults(396018, "SOOTHE"), --The Crybaby Hozen: Fit of Rage
    },
}